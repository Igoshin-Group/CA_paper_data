...
% S(i,:) cell state [x y v o m] at step i + 1
    ...
    delta_t = 60; %(Seconds) This variable is used in nested function!
...
% T=[0.8464,0.088,0.0668
%     0.088,0.8464,0.0668
%  0.0633, 0.0633,0.8733]  ; 
T=[0.912,0.088,0.0
    0.088,0.912,0.0
 0.0633, 0.0633,0.8733]  ;       
